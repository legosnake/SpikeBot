...
class Help extends Command {
	...
	async run (message, args, data) {
		...
		embed.addField("\u200B", message.translate("misc:STATS_FOOTER", {
			donateLink: "https://patreon.com/legosnake",
			dashboardLink: "https://www.netlabstudios.com/dashboard",
			inviteLink: await this.client.generateInvite({
				permissions: ["ADMINISTRATOR"]
			}),
			githubLink: "https://github.com/legosnake/spike",
			supportLink: "https://discord.gg/yxqde3sZZe"
		}));
